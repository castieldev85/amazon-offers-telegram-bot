...
def refill_deals_buffer_for_user(user_id: int, min_discount_percent: int = 20, max_products: int = 10):
    category_code = "cat_deals"
    ...
    # Scraping da deals
    asins = get_deals_asins(min_discount_label="3", max_scrolls=5)
